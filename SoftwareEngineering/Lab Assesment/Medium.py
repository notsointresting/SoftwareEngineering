...
def sendFM(Reciver_Mail,Text):
    ...
    urllib.request.urlretrieve('https://static.toiimg.com/thumb/resizemode-4,width-1200,height-900,msid-79947294/79947294.jpg',"MerryChristmas.jpg")
    
    with open('MerryChristmas.jpg','rb') as f:
        file_data = f.read()
        file_type = imghdr.what(f.name)
        file_name = f.name
